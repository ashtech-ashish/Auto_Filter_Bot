class script(object):
    START_TXT = """<b>​​​ʜɪɪ 👋, 
ɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟʟ ᴍᴇᴅɪᴀ ᴀᴜᴛᴏꜰɪʟᴛᴇʀ ʙᴏᴛ. ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴀʟʟ ʟᴀᴛᴇꜱᴛ ᴍᴏᴠɪᴇꜱ ᴏʀ ꜱᴇʀɪᴇꜱ. ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ. \n<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/becinephile">beCINΞ</a></blockquote></b>"""

    FEATURES_TXT = """<b>ʜᴇʀᴇ ɪꜱ ᴀʟʟ ᴍʏ ꜰᴜɴᴛɪᴏɴꜱ.</b>"""

    ABOUT_TXT = """<b>╭────[ ᴅᴇᴛᴀɪʟs ]────⍟
├⍟ Nᴀᴍᴇ : <a href=https://t.me/{}>{}</a>
├⍟ Oᴡɴᴇʀ : <a href='https://t.me/ax5sh'>W Λ Y И Ǝ</a> 
├⍟ Lɪʙʀᴀʀʏ : <code>ᴘʏʀᴏɢʀᴀᴍ</code>
├⍟ Lᴀɴɢᴜᴀɢᴇ : <code>ᴘʏᴛʜᴏɴ 𝟹</code> 
├⍟ Sᴇʀᴠᴇʀ : <code>ʜᴇʀᴏᴋᴜ</code> 
├⍟ Sᴛᴀᴛᴜꜱ : ᴠ5.1 [ ꜱᴛᴀʙʟᴇ ]
╰───────────────⍟</b>"""

    FORCESUB_TEXT="""<b>
Join our official channel in order to recieve your files.

Click on " Join Now ", Join the channel.
Click on "Try Again" to get your requested files..!
    </b>"""
...
3:- ᴄʀᴇᴀᴛᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ ᴀɴʏ sʜᴏʀᴛɴᴇʀ ʟɪᴋᴇ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴛʜɪs ʙᴇsᴛ sʜᴏʀᴛɴᴇʀ <a href=https://linkshortify.com/ref/axsih>LinkShortify</a>. 
...
<b><blockquote>Any Issues? Contact <a href='https://t.me/becinecontact_bot'>Here</a> ✍🏼</blockquote></b>"""
...
•─────•─────────•─────•
💵 ᴜᴘɪ ɪᴅ - <code>14ashishkumar10d@okicici</code><b>(Tap to Copy)</b>

◉ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ : /myplan 

‼️ ᴍᴜꜱᴛ ꜱᴇɴᴅ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀꜰᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.
‼️ ᴀꜰᴛᴇʀ ꜱᴇɴᴅɪɴɢ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ɢɪᴠᴇ ᴜꜱ ꜱᴏᴍᴇᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ʟɪꜱᴛ."""
