...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002151484893 -1002595119582 -1002075429339 -1002888854366').split()] #Movie Database Channel Id
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002679083488')) #Premium Subscription Log Channel Id
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002166741768') #Movie Request Channel Id
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/becinerequestgroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/becinephile')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/cinephilesupport_bot')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002679083488')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://envs.sh/KD4.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/howtoopenverifylinks/24")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/howtoopenverifylinks/24")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/howtoopenverifylinks/24")

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "71c4fe7a7cf4d30019ed3777facd36bb617ba281")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "seturl.in")

SHORTENER_API2 = environ.get("SHORTENER_API2", "71c4fe7a7cf4d30019ed3777facd36bb617ba281")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "seturl.in")

SHORTENER_API3 = environ.get("SHORTENER_API3", "71c4fe7a7cf4d30019ed3777facd36bb617ba281")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+w-Z-lpWYp2EzYzI1') #Support Chat Link with https://
...
Bot_cmds = {
    ...
    "filter": "Add random filter",
    "link": "Create single file store link",
    "batch": "Create multiple file store link",
    "myplan" : "Check premium subscription (When ON)",
    "settings": "Change settings (Only in group)",
    "details": "Check details (Only in group)",
    "stats": "Check bot status",
    "restart": "Restart the bot (Only Admins)",
}
